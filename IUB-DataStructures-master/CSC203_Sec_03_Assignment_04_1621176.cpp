...
public:
    ...
    void TreeTracer(TreeNode *root, int level, int lvl_storer)
    {
        ...
        TreeTracer(current -> left, level+1);
        ...
        TreeTracer(current -> right, level+1);
    ...
    void displayTracer(TreeNode *root)
    {
        cout<<"Display code: ";
